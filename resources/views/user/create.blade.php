    <x-app>
        ...
        <div class="card show p-3">
            ...
            @enderror"
                    ...
                    <div class="col-md-6">
                        <label for="passwordconfirmation" class="form-label required">Konfirmasi Password</label>
                        <input type="password"
                            class="form-control @error('passwordconfirmation') is-invalid 
            @enderror"
                            id="passwordconfirmation" name="password_confirmation" required minlength="8"
